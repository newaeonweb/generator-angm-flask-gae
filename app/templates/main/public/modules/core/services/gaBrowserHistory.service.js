(function () {
	...
	angular
		.module('core')
		.factory('gaBrowserHistory', gaBrowserHistory);
	...
	gaBrowserHistory.$inject = ['$state', '$rootScope', '_', 'gaAuthentication'];

	function gaBrowserHistory($state, $rootScope, _, gaAuthentication) {
		var history = [];
